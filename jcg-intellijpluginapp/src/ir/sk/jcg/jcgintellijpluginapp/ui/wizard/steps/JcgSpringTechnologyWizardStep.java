 ...
 */
public class JcgSpringTechnologyWizardStep extends ModuleWizardStep {

    private static final Logger logger = LoggerFactory.getLogger(JcgSpringTechnologyWizardStep.class);
    ...
    public JcgSpringTechnologyWizardStep(JcgModuleBuilder jcgModuleBuilder, WizardContext wizardContext) {
...
//        TechnologyHandler technologyHandler = architecture.getTechnologyByType(TechnologyHandlerType.ORM_TECHNOLOGY);
        SpringHandler springHandler = architecture.getSpringHandler();
        List<PropertyInfo> propertyInfos = new ArrayList<>();
        List<Field> fields = ReflectionUtil.findFields(springHandler.getClass(), Prop.class);

        PropertyInfo propertyInfo = null;
        for (Field field : fields) {
            try {
                propertyInfo = new PropertyInfo(field, springHandler);
