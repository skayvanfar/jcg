 ...
 */
public class JcgBuildTechnologyWizardStep extends ModuleWizardStep {
    ...
    public JcgBuildTechnologyWizardStep(JcgModuleBuilder jcgModuleBuilder, WizardContext wizardContext) {
