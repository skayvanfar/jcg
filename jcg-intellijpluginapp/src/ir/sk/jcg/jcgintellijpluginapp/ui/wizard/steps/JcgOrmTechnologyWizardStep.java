 ...
 */
public class JcgOrmTechnologyWizardStep extends ModuleWizardStep {
    ...
    public JcgOrmTechnologyWizardStep(JcgModuleBuilder jcgModuleBuilder, WizardContext wizardContext) {
